...
export default function Assignments() {
  ...
  const assignments = [
    {
      id: 1,
      title: t('assignments.title1'),
      subject: t('dashboard.math'),
      dueDate: '15.05.2026',
      dueTime: '23:59',
      status: 'pending',
      grade: null,
      description: t('assignments.desc1'),
      teacherComments: [],
    ...
    {
      id: 2,
      title: t('assignments.title2'),
      subject: t('dashboard.cs'),
      dueDate: '16.05.2026',
      dueTime: '23:59',
      status: 'in-progress',
      grade: null,
      description: t('assignments.desc2'),
      teacherComments: [t('assignments.comment2')],
      attachments: ['project-requirements.pdf', 'rubric.pdf'],
      submissionDate: null
    },
    {
      id: 3,
      title: t('assignments.title3'),
      subject: t('dashboard.physics'),
      dueDate: '18.05.2026',
      dueTime: '23:59',
      status: 'pending',
      grade: null,
      description: t('assignments.desc3'),
      teacherComments: [],
    ...
    {
      id: 4,
      title: t('assignments.title4'),
      subject: t('assignments.envScience'),
      dueDate: '12.05.2026',
      dueTime: '23:59',
      status: 'submitted',
      grade: 'A-',
      gradePercentage: 92,
      description: t('assignments.desc4'),
      teacherComments: [t('assignments.comment4')],
      attachments: [],
      submissionDate: '11.05.2026'
    }
  ];
          ...
          <div className="lg:col-span-2">
            {selectedAssignment ? (
              ...
              >
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-6">
                  ...
                  <div className="grid sm:grid-cols-3 gap-4 mt-6">
                    ...
                    <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-xl">
                      ...
                      <div>
                        <p className="text-xs text-slate-600">{t('assignments.dueTime')}</p>
                    ...
                    <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-xl">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-semibold text-slate-900 capitalize">
                          {selectedAssignment.status === 'in-progress' ? t('assignments.inProgress') : t(`assignments.${selectedAssignment.status}`)}
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                {/* Description */}
                <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-6">
                  <h3 className="text-lg font-bold text-slate-900 mb-3">{t('assignments.description')}</h3>
                ...
                {selectedAssignment.status !== 'submitted' && (
                  <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl shadow-lg border border-blue-200 p-6">
                    ...
                    <label className="block">
                      ...
                      <div className="border-2 border-dashed border-blue-300 rounded-xl p-8 text-center cursor-pointer hover:border-blue-500 hover:bg-blue-100/50 transition-all group">
                        ...
                        <h4 className="font-semibold text-slate-900 mb-1">
                          {t('assignments.clickToUpload')}
                        </h4>
                        <p className="text-sm text-slate-600">
                          {t('assignments.supportedFiles')}
                        </p>
                      </div>
                    </label>
                    ...
                    <div className="mt-4">
                      <textarea
                        placeholder={t('assignments.addComment')}
                        ...
                        >
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                              <p className="text-sm font-semibold text-slate-900 mb-1">{t('attendance.drSmith')}</p>
                ...
                {selectedAssignment.submissionDate && (
                  <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl shadow-lg border border-green-200 p-6">
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                      <div>
                        <p className="text-sm text-slate-600 mb-1">{t('assignments.submittedOn')}</p>
                        <p className="text-base font-semibold text-slate-900">{selectedAssignment.submissionDate}</p>
                      </div>
                      <div>
                        <p className="text-sm text-slate-600 mb-1">{t('assignments.gradeReceived')}</p>
              ...
              <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-12 text-center">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-2">{t('assignments.selectAssignment')}</h3>
                <p className="text-slate-600">
                  {t('assignments.chooseFromList')}
                </p>
              </div>
            )}
          </div>

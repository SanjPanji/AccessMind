  ...
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      id: 1,
      type: 'grade',
      title: t('notifications.title1'),
      description: t('notifications.desc1'),
      timestamp: t('notifications.time1'),
      isRead: false,
      date: new Date()
    },
    {
      id: 2,
      type: 'assignment',
      title: t('notifications.title2'),
      description: t('notifications.desc2'),
      timestamp: t('notifications.time2'),
      isRead: false,
      date: new Date()
    },
    {
      id: 3,
      type: 'deadline',
      title: t('notifications.title3'),
      description: t('notifications.desc3'),
      timestamp: t('notifications.time3'),
      isRead: false,
      date: new Date()
    },
    {
      id: 4,
      type: 'grade',
      title: t('notifications.title4'),
      description: t('notifications.desc4'),
      timestamp: t('notifications.time4'),
      isRead: true,
    ...
    },
    {
      id: 5,
      type: 'system',
      title: t('notifications.title5'),
      description: t('notifications.desc5'),
      timestamp: t('notifications.time5'),
      isRead: true,
      date: new Date(Date.now() - 86400000)
    },
    {
      id: 6,
      type: 'assignment',
      title: t('notifications.title6'),
      description: t('notifications.desc6'),
      timestamp: t('notifications.time6'),
      isRead: true,
      date: new Date(Date.now() - 86400000)
    },
    {
      id: 7,
      type: 'grade',
      title: t('notifications.title7'),
      description: t('notifications.desc7'),
      timestamp: t('notifications.time7'),
      isRead: true,
    ...
    },
    {
      id: 8,
      type: 'deadline',
      title: t('notifications.title8'),
      description: t('notifications.desc8'),
      timestamp: t('notifications.time8'),
      isRead: true,

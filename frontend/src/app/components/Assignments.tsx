...
export default function Assignments() {
  ...
  const assignments = [
    {
      id: 1,
      title: 'Advanced Calculus Problem Set 5',
      subject: 'Mathematics',
      dueDate: 'May 15, 2026',
      dueTime: '11:59 PM',
      status: 'pending',
      grade: null,
      description: 'Complete problems 1-15 from Chapter 8. Focus on derivatives and integrals.',
      teacherComments: [],
    ...
    },
    {
      ...
      status: 'in-progress',
      grade: null,
      description: 'Build a full-stack web application using React and Node.js. Include user authentication and database integration.',
      teacherComments: ['Looking good so far! Make sure to add proper error handling.'],
    ...
    },
    {
      ...
      status: 'pending',
      grade: null,
      description: 'Write a comprehensive lab report on the momentum experiment conducted last week.',
      teacherComments: [],
    ...
    },
    {
      ...
      grade: 'A-',
      gradePercentage: 92,
      description: 'Write a 5-page essay analyzing the impact of climate change on coastal ecosystems.',
      teacherComments: ['Excellent analysis! Great use of sources. Minor formatting issues.'],
      attachments: [],
